    ...
    >
      <View style={styles.center}>
        ...
        <Text style={[styles.sub, { color: colors.mutedForeground }]}>
          Olá, {firstName}! Seu cadastro como motorista está sendo analisado
          pela nossa equipe. Você receberá uma resposta em breve.
        </Text>
        ...
        {user?.vehicleModel && (
          ...
          >
            <View style={styles.infoRow}>
              ...
              <Text
                style={[styles.infoTxt, { color: colors.mutedForeground }]}
              >
                {user.name}
              </Text>
            </View>
            <View style={styles.infoRow}>
              <Feather
                name={user.vehicleType === "moto" ? "zap" : "truck"}
                size={14}
        ...
        {message && (
          ...
          >
            ...
            />
            <Text
              style={[styles.msgTxt, { color: colors.mutedForeground }]}
            >
              {message}
            </Text>
          </View>
        ...
        >
          {checking ? (
            ...
            <>
              ...
              />
              <Text
                style={[styles.checkTxt, { color: colors.accentForeground }]}
              >
                Verificar status
              </Text>
            </>
        ...
        >
          <Text style={[styles.logoutTxt, { color: colors.mutedForeground }]}>
            Sair da conta
          </Text>
        </Pressable>
      </View>
