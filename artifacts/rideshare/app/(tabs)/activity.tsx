...
function formatDate(ts: number): string {
  ...
  let day: string;
  if (sameDay(d, today)) day = "Hoje";
  else if (sameDay(d, yest)) day = "Ontem";
  else
    day = d.toLocaleDateString("pt-BR", { month: "short", day: "numeric" });
    ...
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.summaryRow}>
          <View
            style={[styles.summaryCard, { backgroundColor: colors.foreground }]}
          >
            <Text
        ...
        {rides.length === 0 ? (
          <View style={styles.empty}>
            ...
            >
              Seu histórico de corridas vai aparecer aqui.
            </Text>
          </View>
        ) : (
...
const styles = StyleSheet.create({
  ...
  summarySub: { fontSize: 13, fontFamily: "Inter_500Medium" },
  ...
  list: { gap: 12 },
  tripCard: { padding: 16, borderRadius: 18, borderWidth: 1, gap: 14 },
  tripTop: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  tripRoute: { flexDirection: "row", alignItems: "stretch", gap: 12 },
  routeIconCol: { alignItems: "center", paddingTop: 4 },
  routeDot: { width: 10, height: 10, borderRadius: 5 },
  routeLine: { width: 2, flex: 1, minHeight: 14, marginVertical: 4 },
  ...
  tripStatTxt: { fontSize: 12, fontFamily: "Inter_500Medium" },
  tripPrice: {
    marginLeft: "auto",
    fontSize: 16,
    fontFamily: "Inter_700Bold",
